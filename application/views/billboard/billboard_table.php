...
<table cellpadding="0" cellspacing="0" border="0" class="display dataTable" id="billboard_table"  aria-describedby="example_info" >
    <thead>
        <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 171px; " >News ID</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 108px; " >Enable</th>
